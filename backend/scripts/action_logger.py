...
Utilizzato per registrare le azioni di ciascun agente nella simulazione OASIS per il monitoraggio back-end.
...
class PlatformActionLogger:
    """Registratore di azioni su piattaforma singola"""
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Il percorso di base della directory di simulazione
        """
    ...
    def log_round_start(self, round_num: int, simulated_hour: int):
        """Inizia il ciclo di registrazione"""
        entry = {
            "round": round_num,
            "timestamp": datetime.now().isoformat(),
    ...
    def log_round_end(self, round_num: int, actions_count: int):
        """Fine del giro di registrazione"""
        entry = {
            "round": round_num,
            "timestamp": datetime.now().isoformat(),
    ...
    def log_simulation_start(self, config: Dict[str, Any]):
        """Inizio della simulazione della registrazione"""
        entry = {
            "timestamp": datetime.now().isoformat(),
    ...
    def log_simulation_end(self, total_rounds: int, total_actions: int):
        """Fine della simulazione della registrazione"""
        entry = {
            "timestamp": datetime.now().isoformat(),
...
class SimulationLogManager:
    """
    Gestore del registro di simulazione
    Gestione unificata di tutti i file di log, separati per piattaforma
    """
    ...
    def __init__(self, simulation_dir: str):
        ...
        # Configura il registro principale
        self._setup_main_logger()
    
    def _setup_main_logger(self):
        """Imposta il registro principale della simulazione"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Ottieni il logger della piattaforma Twitter"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Ottieni il logger della piattaforma Reddit"""
    ...
    def log(self, message: str, level: str = "info"):
        """registrare il registro principale"""
...
# ============ Compatibile con le vecchie interfacce ============

class ActionLogger:
    """
    Registratore di azioni (compatibile con la vecchia interfaccia)
    Si consiglia invece di utilizzare SimulationLogManager
    """
...
# Istanza di log globale (compatibile con la vecchia interfaccia）
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Ottieni un'istanza di log globale (compatibile con la vecchia interfaccia）"""
