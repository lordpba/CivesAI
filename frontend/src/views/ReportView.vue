<template>
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">Generazione di rapporti</span>
        </div>
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step4 Generazione di rapporti -->
...
// Layout State - Passa alla prospettiva del banco di lavoro per impostazione predefinita
...
const loadReportData = async () => {
  try {
    addLog(`Carica i dati del rapporto: ${currentReportId.value}`)
    
    // Ottieni informazioni sul rapporto da ottenere simulation_id
    ...
    if (reportRes.success && reportRes.data) {
      ...
      addLog(`Impossibile ottenere le informazioni sul rapporto: ${reportRes.error || 'errore sconosciuto'}`)
    }
  } catch (err) {
...
onMounted(() => {
  addLog('ReportView inizializzazione')
  loadReportData()
})
</script>
